...
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| minimización/redacción del preview push                        | el flujo inspeccionado proyecta contenido del mensaje y no demuestra redacción previa | `DELIV-PKG-001..025::<package_id>` para decidir inclusión física en el paquete prioritario | decisión explícita de alcance; si aplica al paquete, control implementado y probado antes de exposición real |
