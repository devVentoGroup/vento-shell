...
| `pulso.delivery.deliveries.override` | `DELIVERY`      | `delivery_id` + motivo + versión | DELIVERY_INTERSECTION — orden, sede comercial, área operativa, ruta y responsable ∩ ambos carriles | Responsable/asignado como relación; tercero solo por excepción explícita | Solo estado excepcionalmente confirmable; ; bloqueo; idempotencia; auditoría reforzada |
reautenticación según AUTH-CAT-014
##### 15.10 VISO — 17
