### MINI-BLOQUE — IDENTIDAD APLICACIÓN PROCESO Y PASO

<!-- PLAN-SECTION-META:START -->
Esta sección organiza **identidad aplicación proceso y paso** dentro de **E2 PROCESOS Y EXPERIENCIA**. Agrupa tareas que producen un resultado funcional común y deben mantenerse juntas para conservar contexto, trazabilidad y orden de ejecución.

**Cobertura canónica:** `PROC-SCREEN-001` a `PROC-SCREEN-004` — 4 tareas.
