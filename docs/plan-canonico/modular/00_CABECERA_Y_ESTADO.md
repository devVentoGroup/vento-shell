...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-008::GLOBAL** |
| Carril documental | **PAUSADO_POR_ACCION_FISICA_PRIORITARIA — SHELL-CI-009** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-CI-008::GLOBAL** |
...
| Implementación física | **SHELL-CI-008::GLOBAL — PENDING_AUTHORIZATION** |
