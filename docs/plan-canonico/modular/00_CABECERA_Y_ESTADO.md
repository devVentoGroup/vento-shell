...
| Tareas aprobadas | **695** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **899** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **43.60% (695/1594)** |
| Compilado derivado            | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md`                                 |
| Estado del compilado          | **PENDIENTE DE REGENERACIÓN Y VALIDACIÓN EN CI**                                                |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **DATA-UX-004 — Diseñar centro de calidad, frescura, conciliaciones y certificación** |
| Tarea actual | **DATA-UX-005 — Diseñar espacio de investigación de variaciones, anomalías y causas** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **DATA-UX-006 — Diseñar objetivos, metas, drivers, guardrails y acciones de mejora** |
| Bloque actual | **CARRIL NEXO — Remisiones NEXO como primer paquete vertical — etapa 15: CONDITIONAL_DESIGN_ARTIFACTS** |
| Progreso del bloque | **CARRIL NEXO: 119 de 157 aprobadas; DATA-UX-005 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `DATA-UX-004` — Diseñar centro de calidad, frescura, conciliaciones y certificación |
...
| CONTINUIDAD ACTIVA | **CARRIL NEXO: 119 DE 157 APROBADAS — ACTUAL DATA-UX-005** |
...
CARRIL NEXO — 119 de 157 tareas aprobadas
```
