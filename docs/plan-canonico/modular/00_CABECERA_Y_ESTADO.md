...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-UI-007::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-025** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-UI-007::GLOBAL** |
...
| Implementación física | **SHELL-UI-007::GLOBAL — PENDING_AUTHORIZATION** |
