...
| Tareas aprobadas | **677** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **917** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **42.47% (677/1594)** |
| Compilado derivado            | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md`                                 |
| Estado del compilado          | **PENDIENTE DE REGENERACIÓN Y VALIDACIÓN EN CI**                                                |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **DATA-DOM-007 — Definir calidad, certificación, frescura, completitud, unicidad, validez e integridad** |
| Tarea actual | **DATA-DOM-008 — Definir reportes, tableros, exportaciones, suscripciones, alertas y snapshots oficiales** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **DATA-DOM-009 — Definir analítica de ventas, demanda, precios, promociones y canales** |
| Bloque actual | **CARRIL NEXO — Remisiones NEXO como primer paquete vertical — etapa 15: CONDITIONAL_DESIGN_ARTIFACTS** |
| Progreso del bloque | **CARRIL NEXO: 101 de 157 aprobadas; DATA-DOM-008 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `DATA-DOM-007` — Definir calidad, certificación, frescura, completitud, unicidad, validez e integridad |
...
| CONTINUIDAD ACTIVA | **CARRIL NEXO: 101 DE 157 APROBADAS — ACTUAL DATA-DOM-008** |
...
CARRIL NEXO — 101 de 157 tareas aprobadas
```
