...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-UI-008::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-025** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-UI-008::GLOBAL** |
...
| Implementación física | **SHELL-UI-008::GLOBAL — PENDING_AUTHORIZATION** |
