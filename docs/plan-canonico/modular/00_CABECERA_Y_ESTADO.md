...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-DB-004::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-022** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-DB-004::GLOBAL** |
...
| Implementación física | **SHELL-DB-004::GLOBAL — PENDING_AUTHORIZATION** |
