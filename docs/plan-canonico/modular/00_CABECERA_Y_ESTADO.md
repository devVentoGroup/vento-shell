...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-UI-017::GLOBAL** |
| Carril documental | **ACTIVO — DATA-NORM-DB-008** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-UI-017::GLOBAL** |
...
| Implementación física | **SHELL-UI-017::GLOBAL — PENDING_AUTHORIZATION** |
