...
| Acción principal obligatoria | **INICIAR_IMPLEMENTACION — SHELL-CI-002::GLOBAL** |
| Carril documental | **PAUSADO_POR_ACCION_FISICA_PRIORITARIA — SHELL-CI-003** |
| Carril físico | **AUTHORIZED — SHELL-CI-002::GLOBAL** |
...
| Implementación física | **SHELL-CI-002::GLOBAL — AUTHORIZED** |
