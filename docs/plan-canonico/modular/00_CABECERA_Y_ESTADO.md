...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CI-002::GLOBAL** |
| Carril documental | **PAUSADO_POR_ACCION_FISICA_PRIORITARIA — SHELL-CI-003** |
| Carril físico | **READY_FOR_AUTHORIZATION — SHELL-CI-002::GLOBAL** |
...
| Implementación física | **SHELL-CI-002::GLOBAL — READY_FOR_AUTHORIZATION** |
