...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-UI-002::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-022** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-UI-002::GLOBAL** |
...
| Implementación física | **SHELL-UI-002::GLOBAL — PENDING_AUTHORIZATION** |
