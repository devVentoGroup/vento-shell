...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-DB-001::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-022** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-DB-001::GLOBAL** |
...
| Implementación física | **SHELL-DB-001::GLOBAL — PENDING_AUTHORIZATION** |
