...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CON-003::GLOBAL** |
| Carril documental | **PAUSADO_POR_ACCION_FISICA_PRIORITARIA — AUTH-DB-015** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-CON-003::GLOBAL** |
...
| Implementación física | **SHELL-CON-003::GLOBAL — PENDING_AUTHORIZATION** |
