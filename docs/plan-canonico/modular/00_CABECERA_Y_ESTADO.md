...
| Tareas aprobadas | **890** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **704** |
| Tareas rechazadas | **0** |
...
| Tarea actual | **SHELL-CON-012 — Crear contrato de acciones funcionales** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-CON-013 — Crear contrato de eventos empresariales** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 40 de 109 aprobadas; SHELL-CON-012 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-CON-011` — Centralizar identificadores de pantallas |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 40 DE 109 APROBADAS — ACTUAL SHELL-CON-012** |
...
BLOQUE H — 40 de 109 tareas aprobadas
```
