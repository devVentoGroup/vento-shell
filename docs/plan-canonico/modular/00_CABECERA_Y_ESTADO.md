...
| Acción principal obligatoria | **EJECUTAR_IMPLEMENTACION — AUTH-DB-018::GLOBAL** |
| Carril documental | **ACTIVO — ANIMA-AUTH-012** |
| Carril físico | **IN_PROGRESS — AUTH-DB-018::GLOBAL** |
| Alcance físico autorizado | **AUTH-DB-018::GLOBAL** |
...
| Implementación física | **AUTH-DB-018::GLOBAL — IN_PROGRESS** |
