...
| Acción principal obligatoria | **EJECUTAR_IMPLEMENTACION — AUTH-DB-035::GLOBAL** |
| Carril documental | **ACTIVO — ANIMA-UX-015** |
| Carril físico | **IN_PROGRESS — AUTH-DB-035::GLOBAL** |
| Alcance físico autorizado | **AUTH-DB-035::GLOBAL** |
...
| Implementación física | **AUTH-DB-035::GLOBAL — IN_PROGRESS** |
