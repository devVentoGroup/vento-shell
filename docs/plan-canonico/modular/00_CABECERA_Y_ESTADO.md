...
| Tareas aprobadas | **908** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **686** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **56.96% (908/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-NORM-005 — Centralizar diccionarios ortográficos versionados** |
| Tarea actual | **SHELL-NORM-006 — Crear normalización de búsqueda y comparación** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-NORM-007 — Crear previsualización de transformaciones** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 58 de 109 aprobadas; SHELL-NORM-006 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-NORM-005` — Centralizar diccionarios ortográficos versionados |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 58 DE 109 APROBADAS — ACTUAL SHELL-NORM-006** |
...
BLOQUE H — 58 de 109 tareas aprobadas
```
