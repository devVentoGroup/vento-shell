...
| Tareas aprobadas | **1103** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **493** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **69.11% (1103/1596)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **VISO-AUTH-012 — Validar turnos con área incompatible** |
| Tarea actual | **VISO-AUTH-013 — Crear vista previa trabajador × sede × área × turno** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **VISO-AUTH-014 — Crear simulador de permisos efectivos** |
...
| Acción principal obligatoria | **EJECUTAR_IMPLEMENTACION — AUTH-DB-013::GLOBAL** |
| Carril documental | **ACTIVO — VISO-AUTH-013** |
| Carril físico | **IN_PROGRESS — AUTH-DB-013::GLOBAL** |
| Alcance físico autorizado | **AUTH-DB-013::GLOBAL** |

### Continuidad inmediata

| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `VISO-AUTH-012` — Validar turnos con área incompatible |
| Tarea actual | `VISO-AUTH-013` — Crear vista previa trabajador × sede × área × turno — **NO INICIADA** |
| Siguiente tarea | `VISO-AUTH-014` — Crear simulador de permisos efectivos |
...
| Implementación física | **AUTH-DB-013::GLOBAL — IN_PROGRESS** |
...
BLOQUES G Y G2 — 12 de 26 tareas aprobadas
```
