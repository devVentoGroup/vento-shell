...
| Tareas aprobadas | **678** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **916** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **42.53% (678/1594)** |
| Compilado derivado            | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md`                                 |
| Estado del compilado          | **PENDIENTE DE REGENERACIÓN Y VALIDACIÓN EN CI**                                                |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **DATA-DOM-008 — Definir reportes, tableros, exportaciones, suscripciones, alertas y snapshots oficiales** |
| Tarea actual | **DATA-DOM-009 — Definir analítica de ventas, demanda, precios, promociones y canales** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **DATA-DOM-010 — Definir analítica de inventario, abastecimiento, proveedores y logística** |
| Bloque actual | **CARRIL NEXO — Remisiones NEXO como primer paquete vertical — etapa 15: CONDITIONAL_DESIGN_ARTIFACTS** |
| Progreso del bloque | **CARRIL NEXO: 102 de 157 aprobadas; DATA-DOM-009 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `DATA-DOM-008` — Definir reportes, tableros, exportaciones, suscripciones, alertas y snapshots oficiales |
...
| CONTINUIDAD ACTIVA | **CARRIL NEXO: 102 DE 157 APROBADAS — ACTUAL DATA-DOM-009** |
...
CARRIL NEXO — 102 de 157 tareas aprobadas
```
