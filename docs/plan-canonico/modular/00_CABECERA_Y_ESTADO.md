...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CON-024::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-006** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-CON-024::GLOBAL** |
...
| Implementación física | **SHELL-CON-024::GLOBAL — PENDING_AUTHORIZATION** |
