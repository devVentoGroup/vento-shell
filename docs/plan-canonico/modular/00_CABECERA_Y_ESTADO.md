...
| Tareas aprobadas | **930** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **664** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **58.34% (930/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-UI-013 — Compartir panel de acción principal** |
| Tarea actual | **SHELL-UI-014 — Compartir confirmaciones de acciones sensibles** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-UI-015 — Compartir diagnóstico de contexto** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 80 de 109 aprobadas; SHELL-UI-014 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-UI-013` — Compartir panel de acción principal |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 80 DE 109 APROBADAS — ACTUAL SHELL-UI-014** |
...
BLOQUE H — 80 de 109 tareas aprobadas
```
