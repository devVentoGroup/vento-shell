...
| Tareas aprobadas | **891** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **703** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **55.90% (891/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-CON-012 — Crear contrato de acciones funcionales** |
| Tarea actual | **SHELL-CON-013 — Crear contrato de eventos empresariales** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-CON-014 — Crear contrato de traspasos entre aplicaciones** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 41 de 109 aprobadas; SHELL-CON-013 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-CON-012` — Crear contrato de acciones funcionales |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 41 DE 109 APROBADAS — ACTUAL SHELL-CON-013** |
...
BLOQUE H — 41 de 109 tareas aprobadas
```
