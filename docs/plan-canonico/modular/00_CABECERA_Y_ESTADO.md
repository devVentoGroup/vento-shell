...
| Tareas aprobadas | **909** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **685** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **57.03% (909/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-NORM-006 — Crear normalización de búsqueda y comparación** |
| Tarea actual | **SHELL-NORM-007 — Crear previsualización de transformaciones** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-NORM-008 — Crear metadatos de versión y auditoría de reglas** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 59 de 109 aprobadas; SHELL-NORM-007 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-NORM-006` — Crear normalización de búsqueda y comparación |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 59 DE 109 APROBADAS — ACTUAL SHELL-NORM-007** |
...
BLOQUE H — 59 de 109 tareas aprobadas
```
