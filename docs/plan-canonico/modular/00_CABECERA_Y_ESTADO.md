...
| Acción principal obligatoria | **INICIAR_IMPLEMENTACION — SHELL-CI-005::GLOBAL** |
| Carril documental | **PAUSADO_POR_ACCION_FISICA_PRIORITARIA — SHELL-CI-006** |
| Carril físico | **AUTHORIZED — SHELL-CI-005::GLOBAL** |
| Alcance físico autorizado | **SHELL-CI-005::GLOBAL** |
...
| Implementación física | **SHELL-CI-005::GLOBAL — AUTHORIZED** |
