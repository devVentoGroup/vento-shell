...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CON-002::GLOBAL** |
| Carril documental | **PAUSADO_POR_ACCION_FISICA_PRIORITARIA — AUTH-DB-015** |
| Carril físico | **READY_FOR_AUTHORIZATION — SHELL-CON-002::GLOBAL** |
...
| Implementación física | **SHELL-CON-002::GLOBAL — READY_FOR_AUTHORIZATION** |
