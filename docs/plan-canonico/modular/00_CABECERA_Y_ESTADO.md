...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-UI-001::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-022** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-UI-001::GLOBAL** |
...
| Implementación física | **SHELL-UI-001::GLOBAL — PENDING_AUTHORIZATION** |
