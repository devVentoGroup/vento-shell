...
| Tareas aprobadas | **413** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **1162** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **26.22% (413/1575)** |
| Compilado derivado            | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md`                                 |
| Estado del compilado          | **PENDIENTE DE REGENERACIÓN Y VALIDACIÓN EN CI**                                                |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SUPA-ARC-008 — Definir modelo canónico de Auth e identidad empresarial** |
| Tarea actual | **SUPA-ARC-009 — Definir vínculo de `auth.users` con trabajador, cliente y dispositivo** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SUPA-ARC-010 — Definir ciclo de sesión, revocación y desactivación** |
| Bloque actual | **BLOQUE E3 — Arquitectura canónica de datos y gobierno integral de Supabase** |
| Progreso del bloque | **BLOQUE E3: 8 de 25 aprobadas; SUPA-ARC-009 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SUPA-ARC-008` — Definir modelo canónico de Auth e identidad empresarial |
...
| BLOQUE E3 | **8 DE 25 APROBADAS — ACTUAL SUPA-ARC-009** |
...
BLOQUE E3 — 8 de 25 tareas aprobadas
```
