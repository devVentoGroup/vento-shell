...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-DB-005::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-022** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-DB-005::GLOBAL** |
...
| Implementación física | **SHELL-DB-005::GLOBAL — PENDING_AUTHORIZATION** |
