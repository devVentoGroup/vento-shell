...
| Tareas aprobadas | **910** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **684** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **57.09% (910/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-NORM-007 — Crear previsualización de transformaciones** |
| Tarea actual | **SHELL-NORM-008 — Crear metadatos de versión y auditoría de reglas** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-NORM-009 — Probar idempotencia y conservación semántica** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 60 de 109 aprobadas; SHELL-NORM-008 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-NORM-007` — Crear previsualización de transformaciones |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 60 DE 109 APROBADAS — ACTUAL SHELL-NORM-008** |
...
BLOQUE H — 60 de 109 tareas aprobadas
```
