...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-NORM-001::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-006** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-NORM-001::GLOBAL** |
...
| Implementación física | **SHELL-NORM-001::GLOBAL — PENDING_AUTHORIZATION** |
