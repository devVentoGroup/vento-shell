...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-CON-016::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-016** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-CON-016::GLOBAL** |
...
| Implementación física | **SHELL-CON-016::GLOBAL — PENDING_AUTHORIZATION** |
