...
| Acción principal obligatoria | **AUTORIZAR_IMPLEMENTACION — SHELL-NORM-007::GLOBAL** |
| Carril documental | **ACTIVO — AUTH-DB-021** |
| Carril físico | **PENDING_AUTHORIZATION — SHELL-NORM-007::GLOBAL** |
...
| Implementación física | **SHELL-NORM-007::GLOBAL — PENDING_AUTHORIZATION** |
