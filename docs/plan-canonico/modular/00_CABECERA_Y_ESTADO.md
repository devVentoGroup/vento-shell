...
| Tareas aprobadas | **929** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **665** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **58.28% (929/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **SHELL-UI-012 — Compartir línea de estados de proceso** |
| Tarea actual | **SHELL-UI-013 — Compartir panel de acción principal** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **SHELL-UI-014 — Compartir confirmaciones de acciones sensibles** |
| Bloque actual | **BLOQUE H — Fundación compartida de VENTO-SHELL** |
| Progreso del bloque | **BLOQUE H: 79 de 109 aprobadas; SHELL-UI-013 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `SHELL-UI-012` — Compartir línea de estados de proceso |
...
| CONTINUIDAD ACTIVA | **BLOQUE H: 79 DE 109 APROBADAS — ACTUAL SHELL-UI-013** |
...
BLOQUE H — 79 de 109 tareas aprobadas
```
