...
| Acción principal obligatoria | **EJECUTAR_IMPLEMENTACION — AUTH-DB-036::GLOBAL** |
| Carril documental | **ACTIVO — ANIMA-UX-013** |
| Carril físico | **IMPLEMENTED — AUTH-DB-036::GLOBAL** |
| Alcance físico autorizado | **AUTH-DB-036::GLOBAL** |
...
| Implementación física | **AUTH-DB-036::GLOBAL — IMPLEMENTED** |
