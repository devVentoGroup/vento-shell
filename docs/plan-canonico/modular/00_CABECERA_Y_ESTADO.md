...
| Última tarea aprobada | **AUTH-UI-024 — Definir acción principal** |
| Tarea actual | **AUTH-UI-025 — Definir acciones secundarias** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **AUTH-UI-026 — Identificar vistas duplicadas** |
| Bloque actual | **BLOQUE I — Navegación, pantallas y autorización de vistas** |
| Progreso del bloque | **BLOQUE I: 24 de 29 aprobadas; AUTH-UI-025 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `AUTH-UI-024` — Definir acción principal |
...
| BLOQUE I | **24 DE 29 APROBADAS — ACTUAL AUTH-UI-025** |
...
BLOQUE I — 24 de 29 tareas aprobadas
```
