...
| Tareas aprobadas | **855** |
| Tareas en propuesta | **0** |
| Tareas no iniciadas | **739** |
| Tareas rechazadas | **0** |
| Porcentaje de completamiento | **53.64% (855/1594)** |
| Compilado derivado local      | `.generated/PLAN_IMPLEMENTACION_VENTO_OS_CANONICO_COMPILADO.md` — regenerable; no versionado    |
| Estado del compilado          | **REGENERABLE LOCALMENTE; CI LO PUBLICA TEMPORALMENTE TRAS VALIDAR**                             |
| ADR vigente                   | `ADR-AUTH-001 — ACCEPTED`                                                                       |
| Última tarea aprobada | **CUTOVER-OPS-004 — Diseñar controles contra doble registro y doble efecto durante la transición** |
| Tarea actual | **CUTOVER-OPS-005 — Definir conciliaciones durante el piloto** |
| Estado de la tarea actual | **NO INICIADA** |
| Siguiente tarea | **CUTOVER-OPS-006 — Definir criterio de pausa, reversión o continuación** |
| Bloque actual | **BLOQUE E5 — Paquetes, readiness, cutover e hypercare** |
| Progreso del bloque | **BLOQUE E5: 44 de 68 aprobadas; CUTOVER-OPS-005 pendiente** |
...
| Estado          | Valor                                                                                                  |
| --------------- | ------------------------------------------------------------------------------------------------------ |
| Última aprobada | `CUTOVER-OPS-004` — Diseñar controles contra doble registro y doble efecto durante la transición |
...
| CONTINUIDAD ACTIVA | **BLOQUE E5: 44 DE 68 APROBADAS — ACTUAL CUTOVER-OPS-005** |
...
BLOQUE E5 — 44 de 68 tareas aprobadas
```
