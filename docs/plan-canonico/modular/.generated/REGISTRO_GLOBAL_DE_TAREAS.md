...
| --- | --- | --- |
| Última aprobada | `VISO-AUTH-011` — Validar turnos sin rol operativo | ✅ APROBADA |
| Tarea actual | `VISO-AUTH-012` — Validar turnos con área incompatible | ⬜ NO INICIADA |
| Siguiente reservada | `VISO-AUTH-013` — Crear vista previa trabajador × sede × área × turno | ⬜ NO INICIADA |
