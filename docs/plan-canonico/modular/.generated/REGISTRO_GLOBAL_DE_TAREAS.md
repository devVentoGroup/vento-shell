...
| --- | --- | --- |
| Última aprobada | `INT-SALES-001` — Definir contrato para que PULSO registre la venta | ✅ APROBADA |
...
| Siguiente reservada | `INT-SALES-003` — Definir registro de salida de inventario en NEXO | ⬜ NO INICIADA |
