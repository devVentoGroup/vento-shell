...
| No iniciadas | **957** |
| Rechazadas | **0** |
| Porcentaje de completamiento | **39.96% (637/1594)** |

## Continuidad activa

| Relación | Tarea | Estado |
| --- | --- | --- |
| Última aprobada | `TI-UX-002` — Diseñar mesa de servicio de VISO con colas, prioridad, SLA, asignación, comunicación y validación | ✅ APROBADA |
| Tarea actual | `TI-UX-003` — Diseñar mapa de dispositivos, redes, impresoras, aplicaciones y salud técnica | ⬜ NO INICIADA |
| Siguiente reservada | `TI-UX-004` — Diseñar flujos de incidente, problema, cambio, mantenimiento y recuperación | ⬜ NO INICIADA |
