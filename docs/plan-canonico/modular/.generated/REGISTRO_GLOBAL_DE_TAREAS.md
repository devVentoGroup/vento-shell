...
| No iniciadas | **599** |
| Rechazadas | **0** |
| Porcentaje de completamiento | **62.42% (995/1594)** |

## Continuidad activa

| Relación | Tarea | Estado |
| --- | --- | --- |
| Última aprobada | `AUTH-SRV-012` — Evitar operaciones entre sedes no autorizadas | ✅ APROBADA |
| Tarea actual | `AUTH-SRV-013` — Evitar operaciones entre áreas no autorizadas | ⬜ NO INICIADA |
| Siguiente reservada | `AUTH-SRV-014` — Registrar actor real y actor operativo | ⬜ NO INICIADA |
