...
| --- | --- | --- |
| Última aprobada | `INT-POS-024` — Definir revocación o reducción de credenciales cuando PULSO asuma la fuente | ✅ APROBADA |
| Tarea actual | `INT-SALES-001` — Definir contrato para que PULSO registre la venta | ⬜ NO INICIADA |
| Siguiente reservada | `INT-SALES-002` — Definir emisión en PULSO del mismo contrato canónico utilizado durante la transición | ⬜ NO INICIADA |
