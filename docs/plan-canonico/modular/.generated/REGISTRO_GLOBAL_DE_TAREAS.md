...
| No iniciadas | **598** |
| Rechazadas | **0** |
| Porcentaje de completamiento | **62.48% (996/1594)** |

## Continuidad activa

| Relación | Tarea | Estado |
| --- | --- | --- |
| Última aprobada | `AUTH-SRV-013` — Evitar operaciones entre áreas no autorizadas | ✅ APROBADA |
| Tarea actual | `AUTH-SRV-014` — Registrar actor real y actor operativo | ⬜ NO INICIADA |
| Siguiente reservada | `AUTH-SRV-015` — Registrar rol simulado en auditoría | ⬜ NO INICIADA |
