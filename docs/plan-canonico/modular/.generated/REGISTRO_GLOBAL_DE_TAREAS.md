...
| --- | --- | --- |
| Última aprobada | `INT-SALES-005` — Definir acumulación de puntos en PASS | ✅ APROBADA |
| Tarea actual | `INT-SALES-006` — Definir procesamiento de redención en PASS | ⬜ NO INICIADA |
| Siguiente reservada | `INT-SALES-007` — Definir control contra efectos duplicados por reintento | ⬜ NO INICIADA |
