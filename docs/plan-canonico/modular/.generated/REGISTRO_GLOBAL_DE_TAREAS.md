...
| No iniciadas | **664** |
| Rechazadas | **0** |
| Porcentaje de completamiento | **58.34% (930/1594)** |

## Continuidad activa

| Relación | Tarea | Estado |
| --- | --- | --- |
| Última aprobada | `SHELL-UI-013` — Compartir panel de acción principal | ✅ APROBADA |
| Tarea actual | `SHELL-UI-014` — Compartir confirmaciones de acciones sensibles | ⬜ NO INICIADA |
| Siguiente reservada | `SHELL-UI-015` — Compartir diagnóstico de contexto | ⬜ NO INICIADA |
