...
| --- | --- | --- |
| Última aprobada | `AUTH-DB-010` — Validar principal y actor efectivo dentro de RPC sensibles | ✅ APROBADA |
| Tarea actual | `AUTH-DB-021` — Implementar políticas RLS y grants canónicos por esquema | ⬜ NO INICIADA |
| Siguiente reservada | `AUTH-DB-011` — Aplicar constraints después de backfills y reconciliación | ⬜ NO INICIADA |
