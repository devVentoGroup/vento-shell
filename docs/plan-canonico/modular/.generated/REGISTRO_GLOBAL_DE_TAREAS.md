...
| --- | --- | --- |
| Última aprobada | `INT-SALES-006` — Definir procesamiento de redención en PASS | ✅ APROBADA |
| Tarea actual | `INT-SALES-007` — Definir control contra efectos duplicados por reintento | ⬜ NO INICIADA |
| Siguiente reservada | `INT-SALES-008` — Definir conciliación de convivencia entre POS externo y PULSO | ⬜ NO INICIADA |
