...
| --- | --- | --- |
| Última aprobada | `SHELL-MIG-004` — Sustituir la plantilla histórica por scaffold versionado | ✅ APROBADA |
| Tarea actual | `SHELL-MIG-005` — Migrar componentes, Chrome y estilos por aplicación | ⬜ NO INICIADA |
| Siguiente reservada | `SHELL-MIG-006` — Verificar accesibilidad, tema y movimiento reducido | ⬜ NO INICIADA |
