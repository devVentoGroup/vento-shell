...
| No iniciadas | **898** |
| Rechazadas | **0** |
| Porcentaje de completamiento | **43.66% (696/1594)** |

## Continuidad activa

| Relación | Tarea | Estado |
| --- | --- | --- |
| Última aprobada | `DATA-UX-005` — Diseñar espacio de investigación de variaciones, anomalías y causas | ✅ APROBADA |
| Tarea actual | `DATA-UX-006` — Diseñar objetivos, metas, drivers, guardrails y acciones de mejora | ⬜ NO INICIADA |
| Siguiente reservada | `DATA-UX-007` — Diseñar reportes, exportaciones, suscripciones y snapshots versionados | ⬜ NO INICIADA |
