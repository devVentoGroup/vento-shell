...
| --- | --- | --- |
| Última aprobada | `DATA-UX-001` — Diseñar inicio ejecutivo simple y accionable por rol | ✅ APROBADA |
...
| Siguiente reservada | `DATA-UX-003` — Diseñar tableros por dominio con filtros, comparación, drill-down y trazabilidad | ⬜ NO INICIADA |
