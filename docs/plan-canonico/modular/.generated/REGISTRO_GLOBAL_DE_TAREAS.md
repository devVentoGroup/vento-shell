...
| --- | --- | --- |
| Última aprobada | `CAP-SCOPE-008` — Evaluar producción, planificación, rendimiento, calidad e inocuidad | ✅ APROBADA |
| Tarea actual | `CAP-SCOPE-009` — Evaluar ventas, pedidos, mesas, comandas, caja y pagos | ⬜ NO INICIADA |
| Siguiente | `CAP-SCOPE-010` — Evaluar clientes, fidelización, reclamos y servicio | ⬜ NO INICIADA |
