...
| --- | --- | --- |
| Última aprobada | `PRINT-ARC-012` — Definir confirmación de envío, impresión y entrega cuando sea verificable | ✅ APROBADA |
| Tarea actual | `PRINT-ARC-013` — Definir cancelación y expiración | ⬜ NO INICIADA |
| Siguiente reservada | `PRINT-ARC-014` — Definir reimpresión como acción separada y auditable | ⬜ NO INICIADA |
