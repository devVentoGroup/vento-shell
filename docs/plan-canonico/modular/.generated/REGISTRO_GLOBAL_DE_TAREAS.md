...
| No iniciadas | **738** |
| Rechazadas | **0** |
| Porcentaje de completamiento | **53.70% (856/1594)** |

## Continuidad activa

| Relación | Tarea | Estado |
| --- | --- | --- |
| Última aprobada | `CUTOVER-OPS-005` — Definir conciliaciones durante el piloto | ✅ APROBADA |
| Tarea actual | `CUTOVER-OPS-006` — Definir criterio de pausa, reversión o continuación | ⬜ NO INICIADA |
| Siguiente reservada | `CUTOVER-OPS-007` — Diseñar el registro de incidentes, decisiones y cambios de alcance | ⬜ NO INICIADA |
