...
| --- | --- | --- | --- | --- | --- |
| `DAT-02` | ¿Cuál es la fecha más antigua disponible en Makos? | Administrador de Makos | fecha exacta o al menos mes y año | `POR_COMPROBAR` | la respuesta anterior indicó “desde febrero” sin año |
