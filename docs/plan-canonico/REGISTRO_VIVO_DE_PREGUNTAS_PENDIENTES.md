...
| `ADM-03` | ¿Oficina 1 y Vento Café están dentro del mismo inmueble?                                | Gerencia                | `SÍ`, `NO` o `NO SÉ` | `RESPONDIDA` | `SÍ`                                                                     |
...
| ID       | Pregunta                                                                                            | Responde                         | Qué debe escribir                   | Estado       | Respuesta                      |
| -------- | --------------------------------------------------------------------------------------------------- | -------------------------------- | ----------------------------------- | ------------ | ------------------------------ |
| `COM-01` | ¿De qué lugar sale actualmente el inventario vendido por Vaila Vainilla?                            | responsable de Vaila Vainilla    | un lugar                            | `RESPONDIDA` | OFICINA DE VENTO GROUP         |
| `COM-02` | ¿En qué lugar se empacan actualmente los pedidos de Vaila Vainilla?                                 | responsable de Vaila Vainilla    | un lugar                            | `RESPONDIDA` | OFICNA DE VENTO GROUP          |
| `COM-03` | Cuando un cliente devuelve un producto de Vaila Vainilla, ¿quién recibe el caso y decide qué hacer? | responsable de Vaila Vainilla    | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | CHELSEA, LA DE VENTAS EN LÍNEA |
| `COM-04` | Antes de confirmar una venta de catering, ¿quién debe decir que sí?                                 | Gerencia o responsable comercial | un nombre o cargo                   | `RESPONDIDA` | GERENTE GENERAL                |
| `COM-05` | ¿Existe actualmente un contrato o cotización estándar para catering?                                | Gerencia                         | `SÍ`, `NO` o `NO SÉ`                | `RESPONDIDA` | `SÍ`                           |
...
| ID       | Pregunta                                                                                               | Responde                  | Qué debe escribir             | Estado       | Respuesta                                        |
| -------- | ------------------------------------------------------------------------------------------------------ | ------------------------- | ----------------------------- | ------------ | ------------------------------------------------ |
| `ACT-01` | ¿Cuántos vehículos utiliza actualmente la operación?                                                   | Operaciones               | un número                     | `RESPONDIDA` | 1                                                |
| `ACT-02` | ¿Qué nombre o descripción usan para identificar el vehículo principal?                                 | Operaciones               | una frase corta               | `RESPONDIDA` | VAN                                              |
| `ACT-03` | ¿Qué nombre de empresa o persona aparece en la tarjeta de propiedad del vehículo principal?            | Gerencia o Contabilidad   | un nombre                     | `RESPONDIDA` | NATHALIA IBARRA                                  |
| `ACT-04` | ¿Quién guarda normalmente las llaves y responde por el vehículo principal?                             | Operaciones               | un nombre o cargo             | `RESPONDIDA` | EL CELADOR DEL APARTAMENTO DE LA GERENTE GENERAL |
| `ACT-05` | ¿El vehículo principal se puede usar normalmente en este momento?                                      | conductor u Operaciones   | `SÍ`, `NO` o `PARCIAL`        | `RESPONDIDA` | `SÍ`                                             |
| `ACT-06` | ¿Existe otro vehículo disponible si el principal falla?                                                | Operaciones               | `SÍ`, `NO` o `NO SÉ`          | `RESPONDIDA` | `SÍ`                                             |
| `ACT-07` | ¿Cuántas canastas de transporte existen actualmente?                                                   | Bodega u Operaciones      | un número o `NO SÉ`           | `RESPONDIDA` | `NO SÉ`                                          |
| `ACT-08` | ¿En qué lugares permanecen normalmente las canastas?                                                   | Bodega, conductor y sedes | una lista de lugares          | `RESPONDIDA` | VAN, CENTRO DE PRODUCCIÓN, VENTO CAFÉ            |
| `ACT-09` | ¿Existe algún equipo pendiente de instalar?                                                            | Operaciones               | `SÍ`, `NO` o `NO SÉ`          | `RESPONDIDA` | `NO SÉ`                                          |
| `ACT-10` | ¿Qué equipo está pendiente de instalar?                                                                | Operaciones               | una descripción o `NO APLICA` | `RESPONDIDA` | `NO APLICA`                                      |
| `ACT-11` | ¿Algún equipo, mueble u otra cosa de Vento está prestado o guardado por una persona o empresa externa? | Gerencia u Operaciones    | `SÍ`, `NO` o `NO SÉ`          | `RESPONDIDA` | `SÍ`                                             |
| `ACT-12` | ¿Qué equipo, mueble o cosa de Vento está prestado o guardado por esa persona o empresa externa?        | Gerencia u Operaciones    | una descripción o `NO APLICA` | `RESPONDIDA` | DECORDACIÓN DE TEMPORADAS      │                 |
| `ACT-13` | ¿Hay muebles o decoración de Vento guardados fuera de sus locales u oficinas?                          | Operaciones               | `SÍ`, `NO` o `NO SÉ`          | `RESPONDIDA` | `SÍ`                                             |
| `ACT-14` | ¿Quién guarda normalmente los documentos originales de la empresa?                                     | Gerencia o Contabilidad   | un nombre o cargo             | `RESPONDIDA` | GERENTE GENERAL O CONTADORA                      |
| `ACT-15` | ¿Quién recibe y guarda el efectivo que llega desde las sedes?                                          | Gerencia o Contabilidad   | un nombre o cargo             | `RESPONDIDA` | GERENTE GENERAL                                  |
...
| ID       | Pregunta                                                                                               | Responde                                    | Qué debe escribir                               | Estado      | Respuesta                                                                          |
| -------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------- | ----------------------------------------------- | ----------- | ---------------------------------------------------------------------------------- |
| `DAT-01` | ¿Makos permite descargar las ventas en Excel o en otro archivo?                                        | Caja, Contabilidad o administrador de Makos | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `SÍ`                                                                               |
| `DAT-02` | ¿Cuál es la fecha más antigua disponible en Makos?                                                     | administrador de Makos                      | una fecha o `NO SÉ`                             | `RESPONDIDA` | Desde febrero que contratamos el servicio                                          |
| `DAT-03` | ¿La exportación de Makos muestra cada producto vendido por separado?                                   | Caja o Contabilidad                         | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `SÍ`                                                                               |
| `DAT-04` | ¿Dónde miras cuántas unidades hay disponibles de cada producto?                                        | Bodega u Operaciones                        | un nombre de aplicación, archivo o `NO EXISTE`  | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-05` | ¿En ese mismo lugar puedes ver las cantidades de todas las sedes?                                      | Bodega u Operaciones                        | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-06` | ¿Existe un solo archivo o aplicación donde se puedan consultar las compras anteriores?                 | Compras o Contabilidad                      | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO`                                                                               |
| `DAT-07` | ¿Se guardan las cantidades que realmente se recibieron en entregas anteriores de proveedores?          | Compras o Bodega                            | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO`                                                                               |
| `DAT-08` | ¿Se guardan las solicitudes de remisión enviadas anteriormente?                                        | Operaciones                                 | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `SÍ`                                                                               |
| `DAT-09` | ¿Se guardan las remisiones que ya fueron despachadas?                                                  | Bodega o Logística                          | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO`                                                                               |
| `DAT-10` | ¿Cada sede guarda las remisiones que ya recibió?                                                       | responsables de sede                        | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO`                                                                               |
| `DAT-11` | ¿Se guardan los resultados de conteos de inventario anteriores?                                        | Bodega u Operaciones                        | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO`                                                                               |
| `DAT-12` | ¿Se guarda un registro de lo que realmente se produjo cada día?                                        | responsable de Producción                   | `SÍ`, `NO` o `NO SÉ`                            | `RESPONDIDA` | `NO`                                                                               |
| `DAT-13` | ¿En qué carpeta se guardan las hojas manuales de operación?                                            | Operaciones o Contabilidad                  | una ubicación o `NO EXISTE`                     | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-14` | ¿Dónde se calcula actualmente el pago laboral?                                                         | Contabilidad                                | un archivo, aplicación o proveedor              | `RESPONDIDA` | TNS                                                                                |
| `DAT-15` | ¿Dónde se conserva el resultado final del pago laboral?                                                | Contabilidad                                | un archivo, aplicación o proveedor              | `PENDIENTE` |                                                                                    |
| `DAT-16` | ¿Dónde se guardan actualmente las inspecciones de seguridad y salud?                                   | responsable SST o Gerencia                  | una ubicación o `NO EXISTE`                     | `RESPONDIDA` | Las tiene una empresa externa                                                      |
| `DAT-17` | Cuando una inspección de seguridad encuentra un problema, ¿dónde se anotan las tareas para corregirlo? | responsable SST o Gerencia                  | una ubicación o `NO EXISTE`                     | `RESPONDIDA` | Las anota el encargado de la empresa externa y entrega un informe a la propietaria |
| `DAT-18` | Cuando Gerencia da una instrucción importante, ¿dónde queda escrita?                                   | Gerencia o auxiliar administrativa          | un documento, archivo, aplicación o `NO EXISTE` | `RESPONDIDA` | Whatsapp o `NO EXISTE`                                                             |
| `DAT-19` | Si esa instrucción escrita tiene un error, ¿dónde se hace la corrección?                               | Gerencia o auxiliar administrativa          | un documento, archivo, aplicación o `NO EXISTE` | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-20` | ¿Qué documento acompaña actualmente el paquete de Vaila Vainilla al entregarlo a mensajería?           | responsable de Vaila Vainilla o despachador | un nombre o `NINGUNO`                           | `RESPONDIDA` | Factura                                                                            |
| `DAT-21` | ¿Dónde se registra actualmente que un pedido de Vaila Vainilla fue entregado al cliente?               | responsable de Vaila Vainilla               | una aplicación, chat, archivo o `NO EXISTE`     | `RESPONDIDA` | Whatsapp                                                                           |
| `DAT-22` | ¿Dónde se registra actualmente cómo se repartieron las propinas?                                       | Gerencia o Contabilidad                     | un archivo, aplicación, papel o `NO EXISTE`     | `RESPONDIDA` | Un archivo                                                                         |
| `DAT-23` | ¿Dónde se registra actualmente una venta anulada?                                                      | Caja o responsable de sede                  | una aplicación, archivo, papel o `NO EXISTE`    | `RESPONDIDA` | Makos                                                                              |
| `DAT-24` | ¿Dónde se registra actualmente una devolución de cliente?                                              | Caja o responsable de sede                  | una aplicación, archivo, chat o `NO EXISTE`     | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-25` | Si se da a un cliente un producto, descuento o dinero por un problema, ¿dónde queda anotado?           | Caja o responsable de sede                  | una aplicación, archivo, chat o `NO EXISTE`     | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-26` | Si se corrige la cantidad registrada de un producto, ¿dónde queda anotada esa corrección?              | responsable de inventario o sede            | una aplicación, archivo, papel o `NO EXISTE`    | `RESPONDIDA` | `NO EXISTE`                                                                        |
| `DAT-27` | ¿Cómo se llama el formato donde se registra actualmente una merma?                                     | Producción, Cocina o responsable de sede    | un nombre o `NO EXISTE`                         | `RESPONDIDA` | Formato de mermas                                                                  |
...
| ID       | Pregunta                                                                                                              | Responde                                   | Qué debe escribir                   | Estado      | Respuesta                                                  |
| -------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ----------------------------------- | ----------- | ---------------------------------------------------------- |
| `OPE-01` | ¿En qué lugares se almacenan productos en frío?                                                                       | responsables de sede, Bodega o Producción  | una lista de lugares                | `RESPONDIDA` | CUARTO FRÍO Y CUARTO DE CONGELACIÓN O NEVERAS HORIZONTALES |
| `OPE-02` | ¿En qué sedes se aceptan reservas actualmente?                                                                        | responsables de sede                       | una lista o `NINGUNA`               | `RESPONDIDA` | VENTO CAFÉ                                                 |
| `OPE-03` | ¿En qué sedes se realizan eventos actualmente?                                                                        | Gerencia o responsables de sede            | una lista o `NINGUNA`               | `RESPONDIDA` | `NINGUNA`                                                  |
| `OPE-04` | Si ya enviaste una solicitud de remisión y necesitas cambiarla, ¿a quién debes pedirle permiso?                       | responsable de sede o área                 | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | `NADIE`                                                    |
| `OPE-05` | Si llega mercancía diferente a la solicitada, ¿quién puede decidir que no se reciba?                                  | persona que recibe proveedores             | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | GERENTE GENERAL                                            |
| `OPE-06` | Si al contar un producto la cantidad no coincide, ¿a quién debes pedirle permiso para cambiar la cantidad registrada? | responsable de inventario o sede           | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | GERENTE GENERAL                                            |
| `OPE-07` | Si una venta quedó con el medio de pago equivocado, ¿a quién debes pedirle permiso para corregirlo?                   | cajero o responsable de sede               | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | `NADIE`                                                    |
| `OPE-08` | Si un horario ya fue enviado a los trabajadores, ¿a quién debes pedirle permiso para cambiarlo?                       | persona que administra horarios            | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | GERENTE GENERAL                                            |
| `OPE-09` | Si una hora de entrada o salida quedó equivocada, ¿a quién debes pedirle permiso para corregirla?                     | trabajador o persona que revisa asistencia | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | `NADIE`                                                    |
| `OPE-10` | Si un cliente pide devolver un producto, ¿quién puede decir que sí o que no?                                          | cajero o responsable de sede               | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | PROPIETARIA                                                |
| `OPE-11` | Si se quiere dar al cliente un producto, descuento o dinero por un problema, ¿quién puede decir que sí o que no?      | cajero o responsable de sede               | un nombre, cargo, `NADIE` o `NO SÉ` | `RESPONDIDA` | PROPIETARIA                                                |
...
| ID       | Pregunta                                                                       | Responde                    | Qué debe escribir        | Estado      | Respuesta |
| -------- | ------------------------------------------------------------------------------ | --------------------------- | ------------------------ | ----------- | --------- |
| `EXT-01` | ¿La dirección de Oficina 1 debe actualizarse en Cámara de Comercio?            | asesor contable o jurídico  | `SÍ`, `NO` o `NO APLICA` | `RESPONDIDA` | `NO`      |
| `EXT-02` | ¿La dirección de Oficina 1 debe actualizarse en el RUT?                        | asesor tributario           | `SÍ`, `NO` o `NO APLICA` | `RESPONDIDA` | `NO`      |
| `EXT-03` | ¿La dirección de Oficina 1 debe actualizarse ante el banco?                    | Contabilidad o banco        | `SÍ`, `NO` o `NO APLICA` | `RESPONDIDA` | `NO`      |
| `EXT-04` | ¿La dirección de Oficina 1 debe actualizarse ante la aseguradora?              | Gerencia o aseguradora      | `SÍ`, `NO` o `NO APLICA` | `RESPONDIDA` | `NO`      |
| `EXT-05` | ¿Oficina 1 debe registrarse legalmente como un establecimiento de comercio?    | asesor jurídico o registral | `SÍ`, `NO` o `NO APLICA` | `RESPONDIDA` | `NO`      |
| `EXT-06` | ¿Existe un documento vigente que permita a Vento usar la marca Vento Café?     | Gerencia o asesor jurídico  | `SÍ`, `NO` o `NO SÉ`     | `RESPONDIDA` | `NO`      |
| `EXT-07` | ¿Existe un documento vigente que permita a Vento usar la marca Saudo?          | Gerencia o asesor jurídico  | `SÍ`, `NO` o `NO SÉ`     | `RESPONDIDA` | `NO`      |
| `EXT-08` | ¿Existe un documento vigente que permita a Vento usar la marca Molka?          | Gerencia o asesor jurídico  | `SÍ`, `NO` o `NO SÉ`     | `RESPONDIDA` | `NO`      |
| `EXT-09` | ¿Existe un documento vigente que permita a Vento usar la marca Vaila Vainilla? | Gerencia o asesor jurídico  | `SÍ`, `NO` o `NO SÉ`     | `RESPONDIDA` | `NO`      |
