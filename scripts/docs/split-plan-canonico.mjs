...
const markers = {
  ...
  E1: lineStartIndex(/^## BLOQUE E1\s*$/m, 'BLOQUE E1'),
  E2: lineStartIndex(/^## BLOQUE E2\s*$/m, 'BLOQUE E2'),
  E3: lineStartIndex(/^## BLOQUE E3\s*$/m, 'BLOQUE E3'),
  E4: lineStartIndex(/^## BLOQUE E4\s*$/m, 'BLOQUE E4'),
  E5: lineStartIndex(/^## BLOQUE E5\s*$/m, 'BLOQUE E5'),
...
for (let i = 1; i <= 30; i += 1) t[`CTX${i}`] = taskIndex(`AUTH-CTX-${String(i).padStart(3, '0')}`);
...
const segments = [
  ...
  [
    ...
    t.RBAC27,
    markers.E,
  ],  ['bloques/E_CONTEXTO_Y_DECISION/00_INTRO.md', markers.E, t.CTX1],
  ['bloques/E_CONTEXTO_Y_DECISION/01_CONTRATOS_BASE/AUTH_CTX_001.md', t.CTX1, t.CTX2],
  ['bloques/E_CONTEXTO_Y_DECISION/01_CONTRATOS_BASE/AUTH_CTX_002.md', t.CTX2, t.CTX3],
  ['bloques/E_CONTEXTO_Y_DECISION/01_CONTRATOS_BASE/AUTH_CTX_003.md', t.CTX3, t.CTX4],
  ['bloques/E_CONTEXTO_Y_DECISION/01_CONTRATOS_BASE/AUTH_CTX_004.md', t.CTX4, t.CTX5],
  ['bloques/E_CONTEXTO_Y_DECISION/02_IDENTIDAD_Y_ACTOR/AUTH_CTX_005.md', t.CTX5, t.CTX6],
  ['bloques/E_CONTEXTO_Y_DECISION/02_IDENTIDAD_Y_ACTOR/AUTH_CTX_006.md', t.CTX6, t.CTX7],
  ['bloques/E_CONTEXTO_Y_DECISION/02_IDENTIDAD_Y_ACTOR/AUTH_CTX_007.md', t.CTX7, t.CTX8],
  ['bloques/E_CONTEXTO_Y_DECISION/02_IDENTIDAD_Y_ACTOR/AUTH_CTX_008.md', t.CTX8, t.CTX9],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_009.md', t.CTX9, t.CTX10],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_010.md', t.CTX10, t.CTX11],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_011.md', t.CTX11, t.CTX12],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_012.md', t.CTX12, t.CTX13],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_013.md', t.CTX13, t.CTX14],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_014.md', t.CTX14, t.CTX15],
  ['bloques/E_CONTEXTO_Y_DECISION/03_CONTEXTO_LABORAL_Y_DISPOSITIVO/AUTH_CTX_015.md', t.CTX15, t.CTX16],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_016.md', t.CTX16, t.CTX17],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_017.md', t.CTX17, t.CTX18],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_018.md', t.CTX18, t.CTX19],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_019.md', t.CTX19, t.CTX20],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_020.md', t.CTX20, t.CTX21],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_021.md', t.CTX21, t.CTX22],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_022.md', t.CTX22, t.CTX23],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_023.md', t.CTX23, t.CTX24],
  ['bloques/E_CONTEXTO_Y_DECISION/04_DECISION_DE_AUTORIZACION/AUTH_CTX_024.md', t.CTX24, t.CTX25],
  ['bloques/E_CONTEXTO_Y_DECISION/05_IMPLEMENTACION_Y_TRANSICION/AUTH_CTX_025.md', t.CTX25, t.CTX26],
  ['bloques/E_CONTEXTO_Y_DECISION/05_IMPLEMENTACION_Y_TRANSICION/AUTH_CTX_026.md', t.CTX26, t.CTX27],
  ['bloques/E_CONTEXTO_Y_DECISION/05_IMPLEMENTACION_Y_TRANSICION/AUTH_CTX_027.md', t.CTX27, t.CTX28],
  ['bloques/E_CONTEXTO_Y_DECISION/05_IMPLEMENTACION_Y_TRANSICION/AUTH_CTX_028.md', t.CTX28, t.CTX29],
  ['bloques/E_CONTEXTO_Y_DECISION/05_IMPLEMENTACION_Y_TRANSICION/AUTH_CTX_029.md', t.CTX29, t.CTX30],
  ['bloques/E_CONTEXTO_Y_DECISION/05_IMPLEMENTACION_Y_TRANSICION/AUTH_CTX_030.md', t.CTX30, markers.E1],
  ['bloques/E1_DESCUBRIMIENTO_OPERATIVO/00_BLOQUE_E1.md', markers.E1, markers.E2],
  ['bloques/E2_PROCESOS_Y_EXPERIENCIA/00_BLOQUE_E2.md', markers.E2, markers.E3],
  ['bloques/E3_SUPABASE/00_BLOQUE_E3.md', markers.E3, markers.E4],
  ['bloques/E4_SERVICIOS_TRANSVERSALES/00_BLOQUE_E4.md', markers.E4, markers.E5],
  ['bloques/E5_PLANIFICACION_DE_IMPLEMENTACION/00_BLOQUE_E5.md', markers.E5, markers.F],
  ['bloques/F_ANIMA/00_BLOQUE_F.md', markers.F, markers.G],
  ['bloques/G_VISO/00_BLOQUE_G.md', markers.G, markers.H],
  ['bloques/H_FUNDACION_COMPARTIDA/00_BLOQUE_H.md', markers.H, markers.H2],
  ['bloques/H2_SHELL_APP/00_BLOQUE_H2.md', markers.H2, markers.I],
  ['bloques/I_NAVEGACION_Y_PANTALLAS/00_BLOQUE_I.md', markers.I, markers.J],
  ['bloques/J_ACCIONES_DE_SERVIDOR/00_BLOQUE_J.md', markers.J, markers.K],
  ['bloques/K_NEXO/00_BLOQUE_K.md', markers.K, markers.L],
  ['bloques/L_FOGO/00_BLOQUE_L.md', markers.L, markers.M],
  ['bloques/M_ORIGO/00_BLOQUE_M.md', markers.M, markers.N],
  ['bloques/N_PULSO/00_BLOQUE_N.md', markers.N, markers.O],
  ['bloques/O_NUMERA/00_BLOQUE_O.md', markers.O, markers.P],
  ['bloques/P_DISPOSITIVOS_COMPARTIDOS/00_BLOQUE_P.md', markers.P, markers.Q],
  ['bloques/Q_SIMULACION/00_BLOQUE_Q.md', markers.Q, markers.R],
  ['bloques/R_SUPABASE/00_BLOQUE_R.md', markers.R, markers.S],
  ['bloques/S_MENSAJES_BLOQUEO/00_BLOQUE_S.md', markers.S, markers.T],
  ['bloques/T_CALIDAD_Y_DESPLIEGUE/00_BLOQUE_T.md', markers.T, markers.U],
  ['bloques/U_PRUEBAS_INTEGRALES/00_BLOQUE_U.md', markers.U, markers.V],
  ['bloques/V_PASS/00_BLOQUE_V.md', markers.V, markers.W],
  ['bloques/W_AURA/00_BLOQUE_W.md', markers.W, markers.X],
