...
CREATE TABLE IF NOT EXISTS "public"."inventory_ai_ingestion_actions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "inventory_ai_ingestion_actions_action_type_check" CHECK (("action_type" = ANY (ARRAY['create_product'::"text", 'use_existing'::"text", 'create_entry'::"text", 'reject'::"text"])))
);


ALTER TABLE "public"."inventory_ai_ingestion_actions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."inventory_ai_ingestion_items" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "inventory_ai_ingestion_items_confidence_check" CHECK ((("confidence" >= (0)::numeric) AND ("confidence" <= (1)::numeric))),
    CONSTRAINT "inventory_ai_ingestion_items_match_status_check" CHECK (("match_status" = ANY (ARRAY['matched'::"text", 'unmatched'::"text", 'ambiguous'::"text"]))),
    CONSTRAINT "inventory_ai_ingestion_items_review_status_check" CHECK (("review_status" = ANY (ARRAY['needs_review'::"text", 'approved'::"text", 'rejected'::"text"])))
);


ALTER TABLE "public"."inventory_ai_ingestion_items" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."inventory_ai_ingestion_matches" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "item_id" "uuid" NOT NULL,
    "product_id_candidate" "uuid",
    "score" numeric DEFAULT 0 NOT NULL,
    "reason" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "inventory_ai_ingestion_matches_score_check" CHECK ((("score" >= (0)::numeric) AND ("score" <= (1)::numeric)))
);


ALTER TABLE "public"."inventory_ai_ingestion_matches" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."inventory_ai_ingestions" (
    ...
    "parsed_document" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "inventory_ai_ingestions_flow_type_check" CHECK (("flow_type" = ANY (ARRAY['catalog_create'::"text", 'supplier_entries'::"text"]))),
    CONSTRAINT "inventory_ai_ingestions_source_type_check" CHECK (("source_type" = ANY (ARRAY['pdf'::"text", 'image'::"text"]))),
    CONSTRAINT "inventory_ai_ingestions_status_check" CHECK (("status" = ANY (ARRAY['processing'::"text", 'needs_review'::"text", 'approved'::"text", 'rejected'::"text", 'failed'::"text"])))
);


ALTER TABLE "public"."inventory_ai_ingestions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."inventory_supplier_aliases" (
    ...
    "alias_text_norm" "text" GENERATED ALWAYS AS ("lower"(TRIM(BOTH FROM "alias_text"))) STORED,
    "product_id" "uuid" NOT NULL,
    "supplier_sku" "text",
    "confidence_boost" numeric DEFAULT 0 NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "inventory_supplier_aliases_confidence_boost_check" CHECK ((("confidence_boost" >= (0)::numeric) AND ("confidence_boost" <= 0.3)))
);


ALTER TABLE "public"."inventory_supplier_aliases" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."inventory_ai_ingestion_actions"
    ADD CONSTRAINT "inventory_ai_ingestion_actions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."inventory_ai_ingestion_items"
    ADD CONSTRAINT "inventory_ai_ingestion_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."inventory_ai_ingestion_matches"
    ADD CONSTRAINT "inventory_ai_ingestion_matches_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."inventory_ai_ingestions"
    ADD CONSTRAINT "inventory_ai_ingestions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."inventory_supplier_aliases"
    ADD CONSTRAINT "inventory_supplier_aliases_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_inventory_ai_ingestion_actions_ingestion" ON "public"."inventory_ai_ingestion_actions" USING "btree" ("ingestion_id", "created_at" DESC);



CREATE INDEX "idx_inventory_ai_ingestion_items_review" ON "public"."inventory_ai_ingestion_items" USING "btree" ("review_status");



CREATE INDEX "idx_inventory_ai_ingestion_matches_item" ON "public"."inventory_ai_ingestion_matches" USING "btree" ("item_id");



CREATE INDEX "idx_inventory_ai_ingestions_site_created" ON "public"."inventory_ai_ingestions" USING "btree" ("site_id", "created_at" DESC);



CREATE INDEX "idx_inventory_ai_ingestions_status" ON "public"."inventory_ai_ingestions" USING "btree" ("status");
...
CREATE INDEX "idx_inventory_supplier_aliases_product" ON "public"."inventory_supplier_aliases" USING "btree" ("product_id");
...
CREATE UNIQUE INDEX "ux_inventory_ai_ingestion_items_line" ON "public"."inventory_ai_ingestion_items" USING "btree" ("ingestion_id", "line_no");



CREATE UNIQUE INDEX "ux_inventory_ai_ingestions_dedupe" ON "public"."inventory_ai_ingestions" USING "btree" ("site_id", COALESCE("supplier_id", '00000000-0000-0000-0000-000000000000'::"uuid"), COALESCE("source_document_sha256", ''::"text"));
...
CREATE UNIQUE INDEX "ux_inventory_supplier_aliases_unique" ON "public"."inventory_supplier_aliases" USING "btree" ("supplier_id", "alias_text_norm");
...
CREATE OR REPLACE TRIGGER "update_inventory_ai_ingestion_items_updated_at" BEFORE UPDATE ON "public"."inventory_ai_ingestion_items" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "update_inventory_ai_ingestions_updated_at" BEFORE UPDATE ON "public"."inventory_ai_ingestions" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
CREATE OR REPLACE TRIGGER "update_inventory_supplier_aliases_updated_at" BEFORE UPDATE ON "public"."inventory_supplier_aliases" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
ALTER TABLE ONLY "public"."inventory_ai_ingestion_actions"
    ADD CONSTRAINT "inventory_ai_ingestion_actions_approved_by_fkey" FOREIGN KEY ("approved_by") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."inventory_ai_ingestion_actions"
    ADD CONSTRAINT "inventory_ai_ingestion_actions_ingestion_id_fkey" FOREIGN KEY ("ingestion_id") REFERENCES "public"."inventory_ai_ingestions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_ai_ingestion_actions"
    ADD CONSTRAINT "inventory_ai_ingestion_actions_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."inventory_ai_ingestion_items"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."inventory_ai_ingestion_items"
    ADD CONSTRAINT "inventory_ai_ingestion_items_ingestion_id_fkey" FOREIGN KEY ("ingestion_id") REFERENCES "public"."inventory_ai_ingestions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_ai_ingestion_matches"
    ADD CONSTRAINT "inventory_ai_ingestion_matches_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."inventory_ai_ingestion_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_ai_ingestion_matches"
    ADD CONSTRAINT "inventory_ai_ingestion_matches_product_id_candidate_fkey" FOREIGN KEY ("product_id_candidate") REFERENCES "public"."products"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."inventory_ai_ingestions"
    ADD CONSTRAINT "inventory_ai_ingestions_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."inventory_ai_ingestions"
    ADD CONSTRAINT "inventory_ai_ingestions_site_id_fkey" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_ai_ingestions"
    ADD CONSTRAINT "inventory_ai_ingestions_supplier_id_fkey" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."inventory_supplier_aliases"
    ADD CONSTRAINT "inventory_supplier_aliases_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."inventory_supplier_aliases"
    ADD CONSTRAINT "inventory_supplier_aliases_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_supplier_aliases"
    ADD CONSTRAINT "inventory_supplier_aliases_supplier_id_fkey" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE CASCADE;
...
CREATE POLICY "inventory_ai_ingestion_actions_insert_permission" ON "public"."inventory_ai_ingestion_actions" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_actions"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));



CREATE POLICY "inventory_ai_ingestion_actions_select_permission" ON "public"."inventory_ai_ingestion_actions" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_actions"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));
...
CREATE POLICY "inventory_ai_ingestion_items_delete_permission" ON "public"."inventory_ai_ingestion_items" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_items"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));



CREATE POLICY "inventory_ai_ingestion_items_insert_permission" ON "public"."inventory_ai_ingestion_items" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_items"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));



CREATE POLICY "inventory_ai_ingestion_items_select_permission" ON "public"."inventory_ai_ingestion_items" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_items"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));



CREATE POLICY "inventory_ai_ingestion_items_update_permission" ON "public"."inventory_ai_ingestion_items" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_items"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."inventory_ai_ingestions" "i"
  WHERE (("i"."id" = "inventory_ai_ingestion_items"."ingestion_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));
...
CREATE POLICY "inventory_ai_ingestion_matches_insert_permission" ON "public"."inventory_ai_ingestion_matches" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."inventory_ai_ingestion_items" "ii"
     JOIN "public"."inventory_ai_ingestions" "i" ON (("i"."id" = "ii"."ingestion_id")))
  WHERE (("ii"."id" = "inventory_ai_ingestion_matches"."item_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));



CREATE POLICY "inventory_ai_ingestion_matches_select_permission" ON "public"."inventory_ai_ingestion_matches" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."inventory_ai_ingestion_items" "ii"
     JOIN "public"."inventory_ai_ingestions" "i" ON (("i"."id" = "ii"."ingestion_id")))
  WHERE (("ii"."id" = "inventory_ai_ingestion_matches"."item_id") AND ("public"."has_permission"('nexo.inventory.stock'::"text", "i"."site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "i"."site_id"))))));
...
CREATE POLICY "inventory_ai_ingestions_delete_permission" ON "public"."inventory_ai_ingestions" FOR DELETE TO "authenticated" USING (("public"."has_permission"('nexo.inventory.stock'::"text", "site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "site_id")));



CREATE POLICY "inventory_ai_ingestions_insert_permission" ON "public"."inventory_ai_ingestions" FOR INSERT TO "authenticated" WITH CHECK (("public"."has_permission"('nexo.inventory.stock'::"text", "site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "site_id")));



CREATE POLICY "inventory_ai_ingestions_select_permission" ON "public"."inventory_ai_ingestions" FOR SELECT TO "authenticated" USING (("public"."has_permission"('nexo.inventory.stock'::"text", "site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "site_id")));



CREATE POLICY "inventory_ai_ingestions_update_permission" ON "public"."inventory_ai_ingestions" FOR UPDATE TO "authenticated" USING (("public"."has_permission"('nexo.inventory.stock'::"text", "site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "site_id"))) WITH CHECK (("public"."has_permission"('nexo.inventory.stock'::"text", "site_id") OR "public"."has_permission"('nexo.inventory.entries_emergency'::"text", "site_id")));
...
CREATE POLICY "inventory_supplier_aliases_delete_permission" ON "public"."inventory_supplier_aliases" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "inventory_supplier_aliases_insert_permission" ON "public"."inventory_supplier_aliases" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "inventory_supplier_aliases_select_permission" ON "public"."inventory_supplier_aliases" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "inventory_supplier_aliases_update_permission" ON "public"."inventory_supplier_aliases" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "loyalty_rewards_delete_admin" ON "public"."loyalty_rewards" FOR DELETE TO "authenticated" USING (("public"."is_owner"() OR "public"."is_global_manager"()));



CREATE POLICY "loyalty_rewards_insert_admin" ON "public"."loyalty_rewards" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_owner"() OR "public"."is_global_manager"()));



CREATE POLICY "loyalty_rewards_select_admin" ON "public"."loyalty_rewards" FOR SELECT TO "authenticated" USING (("public"."is_owner"() OR "public"."is_global_manager"()));



CREATE POLICY "loyalty_rewards_update_admin" ON "public"."loyalty_rewards" FOR UPDATE TO "authenticated" USING (("public"."is_owner"() OR "public"."is_global_manager"())) WITH CHECK (("public"."is_owner"() OR "public"."is_global_manager"()));
...
GRANT ALL ON FUNCTION "public"."get_my_total_earned_points"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."register_shift_departure_event_autoclose"("p_site_id" "uuid", "p_distance_meters" integer, "p_accuracy_meters" integer, "p_source" "text", "p_notes" "text", "p_occurred_at" timestamp with time zone, "p_auto_checkout_threshold_meters" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."sync_attendance_events"("p_events" "jsonb") TO "anon";
...
GRANT ALL ON FUNCTION "public"."sync_order_fulfillment_state"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_order_fulfillment_state"() TO "authenticated";
...
GRANT ALL ON TABLE "public"."app_content_blocks" TO "anon";
...
GRANT ALL ON TABLE "public"."attendance_sync_conflicts" TO "anon";
...
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_actions" TO "anon";
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_actions" TO "authenticated";
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_actions" TO "service_role";



GRANT ALL ON TABLE "public"."inventory_ai_ingestion_items" TO "anon";
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_items" TO "authenticated";
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_items" TO "service_role";



GRANT ALL ON TABLE "public"."inventory_ai_ingestion_matches" TO "anon";
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_matches" TO "authenticated";
GRANT ALL ON TABLE "public"."inventory_ai_ingestion_matches" TO "service_role";



GRANT ALL ON TABLE "public"."inventory_ai_ingestions" TO "anon";
GRANT ALL ON TABLE "public"."inventory_ai_ingestions" TO "authenticated";
GRANT ALL ON TABLE "public"."inventory_ai_ingestions" TO "service_role";
...
GRANT ALL ON TABLE "public"."inventory_form_drafts" TO "anon";
...
GRANT ALL ON TABLE "public"."inventory_supplier_aliases" TO "anon";
GRANT ALL ON TABLE "public"."inventory_supplier_aliases" TO "authenticated";
GRANT ALL ON TABLE "public"."inventory_supplier_aliases" TO "service_role";
