...
set
  geofence_check_in_max_accuracy_meters = greatest(geofence_check_in_max_accuracy_meters, 25),
  geofence_ready_cache_ms = greatest(geofence_ready_cache_ms, 120000),
  geofence_latch_ttl_checkin_ms = greatest(geofence_latch_ttl_checkin_ms, 900000),
  updated_at = now();
...
begin
  ...
  -- En check_in, la sede debe estar asignada al empleado.
