...
values
  ('production_consume', 'Consumo de produccion', 'Consumo automatico de ingredientes por lote FOGO', -1),
  ('production_output', 'Entrada de producido', 'Ingreso automatico de producto terminado por lote FOGO', 1)
